...
def vgg_like_3d(ishape=(193, 229, 193)):
    ...
    conv1 = tf.keras.layers.Conv3D(32, kernel_size=(3, 3, 3), activation="relu")(
        input_image
    )
    conv2 = tf.keras.layers.Conv3D(32, kernel_size=(3, 3, 3), activation="relu")(conv1)
    conv3 = tf.keras.layers.Conv3D(
        6, kernel_size=(3, 3, 3), strides=(3, 3, 3), activation="relu"
    )(conv2)
    ...
    conv5 = tf.keras.layers.Conv3D(
        120, kernel_size=(3, 3, 3), strides=(3, 3, 3), activation="relu"
    )(conv4)
    ...
    conv7 = tf.keras.layers.Conv3D(
        240, kernel_size=(3, 3, 3), strides=(3, 3, 3), activation="relu"
    )(conv6)
...
def run_cross_validation(
    ...
    val_folds = ["val_1.txt", "val_2.txt", "val_3.txt", "val_4.txt", "val_5.txt"]

    val_folds = [os.path.join(folds_path, f) for f in val_folds]

    test_folds = ["test_1.txt", "test_2.txt", "test_3.txt", "test_4.txt", "test_5.txt"]
